...
{
    public class Proc_GetListVehicleManufacturers : IEntityProcView
    {
        public const string ProcName = "Proc_GetListVehicleManufacturers";
        public int? Id { get; set; }      
        public string Code { get; set; }
        public string Name { get; set; }
        public int? TotalCount { get; set; }

        public Proc_GetListVehicleManufacturers() { }
